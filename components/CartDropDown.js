...
export default function CartPopDown() {
  ...
  const [openPopDown, setOpenPopDown] = useState(false);
        ...
        {({ openPopDown }) => (
          <div>
            ...
            <button
              ...
              onClick={() => setOpenPopDown((openPopDown) => !openPopDown)}
            >
              <ShoppingBagIcon
            ...
            {openPopDown && open ? (
              ...
              >
                <Popover.Panel
                  className='absolute top-16 inset-x-0 mt-px pb-6 bg-white shadow-lg sm:px-2 lg:top-full lg:left-auto lg:right-0 lg:mt-3 lg:-mr-1.5 lg:w-80 lg:rounded-lg lg:ring-1 lg:ring-black lg:ring-opacity-5 z-10'
                  static
                >
                    ...
                    <ul role='list' className='divide-y divide-gray-200'>
                      {!cartEmpty ? (
                        products.map((p, i) => (
                          <li
                            key={i}
                            className='flex flex-row py-6 cursor-pointer '
                          >
                            <div
